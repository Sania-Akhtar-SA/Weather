...
import javax.swing.*; // GUI and desktop-based application
...
public class Weather extends JFrame implements ActionListener {
    ...
    public Weather() { // container for JFrame
        setTitle("Weather App");
        setSize(1200, 800); // size of the window
        ...
        // Add components to window with borderlayout , we just have two panels that are placed in north and center of the frame
        add(HeadingPanel);
        add(inputPanel);
        add(outputPanel);
        add(feelsLikePanel);
    ...
    public static void main(String[] args) {
        ...
        Weather app = new Weather(); // running the frame window
    }
}
